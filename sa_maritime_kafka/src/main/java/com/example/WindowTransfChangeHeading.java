...
public class WindowTransfChangeHeading implements Transformer<String, AISMessage,KeyValue<String,String>>{
    ...
    public void init(ProcessorContext context) {
        ...
        this.kvStore = context.getStateStore("heading_store");
        this.kvStore.flush();
